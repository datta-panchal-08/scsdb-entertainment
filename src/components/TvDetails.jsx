...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      <div className="w-full  px-5 overflow-x-auto overflow-y-hidden pb-[4%] mb-2  flex">
        {info.details.seasons.length > 0 &&
          info.details.seasons.map((item, index) => {
            return (
              <div key={index} className="min-w-[15%] h-[40vh] mr-4">
                <h1 className="text-sm text-white font-black mb-1">
                  {item.name.split(" ").slice(0, 2).join(" ")}
                </h1>
                <img
                  className=" shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] w-[13vw] h-[37vh] object-cover"
                  src={
